  ...
  return (
    <div className="w-full p-4 border-t-2 flex justify-between items-center  z-[200] ">
      <div className="w-full max-w-[250px] rounded-[10px] border p-3 text-[14px] flex justify-center items-center gap-5 bg-sky-100">
        ...
        <span className="text-sky-700 font-medium">Jan 2023 - Nov 2023</span>
      </div>
          ...
          <div className="flex flex-row gap-7">
            ...
            <form className=" flex w-fit">
              <span
                ...
                className="p-2 py-3 bg-sky-600 text-center sm:w-[50px] rounded-md  text-white transition-all active:scale-95 cursor-pointer relative font-semibold text-[17px]"
              >
                X
              </span>
            </form>
